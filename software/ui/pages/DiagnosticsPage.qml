        ...
        GridLayout {
            ...
            Repeater {
                model: [
                    ...
                    { name: "CVBS DECODER", value: SystemService.decoderOnline ? "Connected · " + VideoService.standard : "Offline", state: SystemService.decoderOnline ? "SIM" : "FAIL", tint: SystemService.decoderOnline ? Theme.blue : Theme.error },
                    { name: "DIGITAL VIDEO", value: VideoService.standard + " · " + VideoService.state, state: VideoService.state === "locked" ? "PASS" : "WARN", tint: VideoService.state === "locked" ? Theme.accent : Theme.warning },
